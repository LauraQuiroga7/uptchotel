                ...
                <div class="col-lg-8 col-md-10">
                    <div class="card">
                        <div class="card-header text-center">
                            ...
                            <p class="mb-0">Complete todos los campos para registrar la reserva</p>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="nameHotel" class="form-label">
                                            <i class="fas fa-building me-1"></i>Nombre del Hotel <span class="required">*</span>
                                        </label>
                                        <input type="text" class="form-control" id="nameHotel" name="nameHotel" required>
                                    </div>
                                    
                                    <div class="col-md-6 mb-3">
                                        <label for="cityHotel" class="form-label">
                                            <i class="fas fa-map-marker-alt me-1"></i>Ciudad del Hotel <span class="required">*</span>
                                        </label>
                                        <input type="text" class="form-control" id="cityHotel" name="cityHotel" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="nameCustomer" class="form-label">
                                            <i class="fas fa-user me-1"></i>Nombre del Cliente <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="documentCustomer" class="form-label">
                                            <i class="fas fa-id-card me-1"></i>Documento de Identidad <span class="required">*</span>
                                        </label>
                                        <input type="text" class="form-control" id="documentCustomer" name="documentCustomer" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="emailCustomer" class="form-label">
                                            <i class="fas fa-envelope me-1"></i>Email del Cliente <span class="required">*</span>
                                        </label>
                                        <input type="email" class="form-control" id="emailCustomer" name="emailCustomer" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="entryDate" class="form-label">
                                            <i class="fas fa-calendar-check me-1"></i>Fecha de Llegada <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="departureDate" class="form-label">
                                            <i class="fas fa-calendar-times me-1"></i>Fecha de Salida <span class="required">*</span>
                                        </label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('entryDate').addEventListener('change', function() {
                ...
                document.getElementById('departureDate').setAttribute('min', entryDate);
        ...
        document.getElementById('reservaForm').addEventListener('submit', function(e) {
            ...
            if (departureDate <= entryDate) {
                mostrarMensaje('La fecha de salida debe ser posterior a la fecha de llegada.', 'danger');
                return;
            }
            ...
            .catch(error => {
                ...
                mostrarMensaje(error || 'Error al registrar la reserva', 'danger');
            });
        });
